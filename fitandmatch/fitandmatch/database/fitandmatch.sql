...
insert  into `category_table`(`cat_id`,`category`) values (1,'Necklace'),(2,'Earring');
...
insert  into `feedback_table`(`f_id`,`cust_id`,`feedback`,`date`) values (1,3,'good','2020-01-04'),(2,3,'good','2020-01-06');
...
insert  into `login_table`(`log_id`,`username`,`password`,`type`) values (1,'admin','admin','admin'),(2,'ss','ss','salesteam'),(3,'ll','ll','logistics'),(4,'uu','uu','user'),(5,'cu','cu','user'),(8,'mi','mi','user');
...
insert  into `logistics_table`(`logi_id`,`log_id`,`logi_name`,`logi_email`,`logi_contact`) values (1,3,'Logistic Team1','logisticteam1@gmail.com','9868755544');
...
insert  into `order_table`(`order_id`,`cust_id`,`pro_id`,`tot_price`,`order_status`,`qty`) values (1,3,1,50000,'confirmed',2),(2,3,3,8000,'confirmed',1),(3,3,4,18000,'confirmed',2),(4,3,2,30000,'requested',1),(5,3,4,9000,'requested',1),(6,2,3,16000,'requested',2);
...
insert  into `orderstatus_table`(`orderstatus_id`,`order_id`,`status`) values (1,1,'On the way'),(2,2,'Shipped'),(3,3,'Shipped'),(4,4,'Pending'),(5,5,'Pending'),(6,6,'Pending');
...
insert  into `payment_table`(`pay_id`,`cust_id`,`order_id`,`pro_id`,`pro_price`,`pay_status`) values (1,3,1,1,'50000','confirmed'),(2,3,2,3,'8000','confirmed'),(3,3,3,4,'18000','confirmed'),(4,3,4,2,'30000','pending'),(5,3,5,4,'9000','pending'),(6,2,6,3,'16000','pending');
...
insert  into `sales_table`(`s_id`,`sales_id`,`order_id`,`s_date`,`status`) values (1,1,1,'2020-01-04','paid'),(2,1,2,'2020-01-04','paid'),(3,1,3,'2020-01-06','paid');
...
insert  into `salesteam_table`(`sales_id`,`log_id`,`sales_name`,`sales_city`,`sales_pincode`,`sales_email`,`sales_contact`) values (1,2,'Sales Team1','Ernakulam','678566','salesteam1@gmail.com','8957647362');
