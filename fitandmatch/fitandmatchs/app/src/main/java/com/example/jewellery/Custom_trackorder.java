...
public class Custom_trackorder extends ArrayAdapter<String> { 
    ...
    public Custom_trackorder(Activity context, String[] orid,String[] oname,String[] quantity,String[] price,String[] orderstatus, String[] img) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.custom_trackorder, null, true);
        ...
        t4.setText("Current Status     :"+orderstatus[position]);
