...
MySQL - 10.4.27-MariaDB : Database - fitandmatch
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fitandmatch` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
(5,20,'sreee','lekha','Female','Onaparambil ','ekm',682505,'sree@gmail.comm','7356507361'),
(13,34,'ammu ','s','Female','oghhgh','ekm',856985,'ammu@gmail.com','8965236587');
...
(14,'salesteam','slt2','salesteam'),
(20,'sreelekha ','sree123','user'),
(26,'vidya','vidya123','user'),
(28,'Sttrivandrum','st2','salesteam'),
(29,'sttrissur','st3','salesteam'),
(30,'stkollam','st4','salesteam'),
(31,'stpalakad','st5','salesteam'),
(32,'logistics','lt2','logistics'),
(33,'logics','lt3','logistics'),
(34,'ammu','amm123','user'),
(35,'stkottayam','st6','salesteam');
...
(4,32,'Logistic Team2','logisticteam2@gmail.com','9852145632'),
(5,33,'Logistic Team2','logisticteam3@gmail.com','7563214512');
...
(8,1,4,27000,'confirmed',3),
(9,5,1,25000,'confirmed',1),
(10,5,4,9000,'confirmed',1),
(11,5,2,30000,'confirmed',1),
(12,5,16,80000,'confirmed',1),
(13,5,17,50000,'confirmed',1),
(14,5,17,50000,'confirmed',1),
(15,5,1,25000,'confirmed',1),
(16,1,17,50000,'cart',1);
...
(5,3,5,4,'9000','confirmed'),
(6,2,6,3,'16000','confirmed'),
(7,1,7,11,'666','confirmed'),
(8,1,8,4,'27000','confirmed'),
(9,5,9,1,'25000','confirmed'),
(10,5,10,4,'9000','confirmed'),
(11,5,11,2,'30000','confirmed'),
(12,5,12,16,'80000','pending'),
(13,5,13,17,'50000','confirmed'),
(14,5,14,17,'50000','pending'),
(15,5,15,1,'25000','confirmed');
...
insert  into `products_table`(`pro_id`,`cat_id`,`pro_img`,`pro_name`,`pro_desc`,`pro_price`) values 
(1,1,'static/uploads/c0022ef4-2d30-11ea-b081-08edb9687060Jewellery-Necklace-PNG-Image.png','Necklace','Necklace with red stone,916','25000'),
(2,1,'static/uploads/f9eb5e1e-2d30-11ea-ae53-08edb9687060ne6.png','Round Necklace','Traditional Necklace','30000'),
(3,2,'static/uploads/026f96c8-2d32-11ea-9a70-08edb9687060eri13.png','Earring','Long earring','8000'),
(4,2,'static/uploads/27f430e2-2d32-11ea-91dd-08edb9687060ear5.png','Peacock Earring','Peacock Earring with white stone','9000'),
(10,4,'static/uploads/7032ebd4-b19e-11ec-9383-489ebd74326bf4.jpg','Round neck t shirt','wedrfgth','2345'),
(11,4,'static/uploads/8297bcba-b19e-11ec-8321-489ebd74326btshirt_PNG5451.png','Round neck t shirt','wertyui','666'),
(17,6,'static/uploads/5eee7640-b8a1-11ec-bcfc-f0cb225cb6b1ring3.png','Ring','multiple stone ring','50000'),
(31,1,'static/uploads/bc7cbac6-b945-11ec-b27a-f0cb225cb6b1necklace1.png','Necklace','Golden necklace with stones','25000'),
(32,9,'static/uploads/06e87134-b946-11ec-af86-f0cb225cb6b1stud2.png','Stud','golden stud with stinle white stone','1200'),
(33,7,'static/uploads/2df404f6-b946-11ec-a0a6-f0cb225cb6b1bangle3.png','Bangle','Golden bangle with stones','5000'),
(34,6,'static/uploads/50f2d6f4-b946-11ec-9579-f0cb225cb6b1ring4.png','Ring','White stone ring with white stone','2000'),
(35,6,'static/uploads/8de3e550-b946-11ec-ab22-f0cb225cb6b1ring1.png','Ring','golden color ring with white stones','2000'),
(36,6,'static/uploads/ad15988c-b946-11ec-897e-f0cb225cb6b1layered_ring.png','Ring','layered white stone ring','2500'),
(37,1,'static/uploads/da8bfc8a-b946-11ec-beba-f0cb225cb6b1neck.png','Necklace','free style diamond necklace white stones','7000'),
(38,1,'static/uploads/ff157fa2-b946-11ec-a552-f0cb225cb6b1necklace2.png','Necklace','white stone necklace with red stone Bridal wear','20000'),
(39,7,'static/uploads/38690d5c-b947-11ec-b774-f0cb225cb6b1bangle2.png','Bangle','Golden color bangle with stones','3000'),
(40,6,'static/uploads/5d864c5e-b947-11ec-a1fd-f0cb225cb6b1ring2.png','Ring','white stone  ring','1500'),
(41,9,'static/uploads/7833f2ca-b947-11ec-8879-f0cb225cb6b1stud1.png','Stud','white stone stud ','1500'),
(42,7,'static/uploads/96bb4d86-b947-11ec-a3b5-f0cb225cb6b1bangle1.png','Bangle','Golden color bangle','1500'),
(43,11,'static/uploads/b9d41234-b965-11ec-9b21-f0cb225cb6b1b2.png','bracelet','white stoned bracelet','2000');
...
(5,1,6,'2022-04-09','paid'),
(6,1,5,'2022-04-10','paid'),
(7,1,8,'2022-04-10','paid'),
(8,8,9,'2022-04-10','paid'),
(9,8,10,'2022-04-10','paid'),
(10,1,11,'2022-04-11','paid'),
(11,1,13,'2022-04-11','paid'),
(12,1,15,'2022-04-11','paid');
...
(7,28,'Sales Team2','Trivandrum','856321','st2@gmail.com','9856321475'),
(8,29,'Sales Team3','Thrissur','236547','st3@gmail.com','9856321475'),
(9,30,'Sales Team4','kollam','125421','st4@gmail.com','8563210245'),
(10,31,'Sales Team5','palakad','523641','st5@gmail.com','8541235621'),
(11,35,'Sales Team6','kottayam','563214','st6@gmail.com','8563214520');
